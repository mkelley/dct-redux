...
class Config:
    ...
    comet_pat = (
        r"^("
        r"([1-9]{1}[0-9]*[PDI](-[A-Z]{1,2})?)"
        r"|([CPX]/-?[0-9]{1,4} [A-Z]{1,2}[1-9][0-9]{0,2}(-[A-Z]{1,2})?)"
        r")"
    )
    asteroid_pat = (
        r"^("
        r"([1-9][0-9]*( [A-Z]{1,2}([1-9][0-9]{0,2})?)?)"
        r"|(\(([1-9][0-9]*)\))"
        r"|(A/-?[0-9]{1,4} [A-Z]{1,2}[1-9][0-9]{0,2}(-[A-Z]{1,2})?)"
        r")"
    )
